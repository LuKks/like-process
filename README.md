...
## Example with PM2
1) With the previous example, remove `this_var_not_exists;`\
2) Start as cluster mode: `pm2 start example.js -i 2 --wait-ready --kill-timeout 7000`\
3) Reload when you want: `pm2 reload example`
